...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db)  {
        ...
        db.execSQL("INSERT INTO Preguntas VALUES (1, 'Button', '¿Quién fue el jugador que marcó en la final del mundial de 2010?', 1,'Iniesta marcó en la prórroga el gol decisivo que dio el título a España en una disputadísima final contra Holanda (0-1)','Andrés Iniesta',NULL,NULL,NULL,NULL,NULL)");
        db.execSQL("INSERT INTO Preguntas VALUES (2, 'Seekbar', '¿Cuál es el máximo número de goles que se han marcado en un partido?', NULL,'El 31 de Octubre de 2002  ek AS Adema ganó al SO I Emyrne 149-0','149',10,200,NULL,NULL,NULL)");
        db.execSQL("INSERT INTO Preguntas VALUES (3, 'Imagen', '¿Donde se jugó la final de la Champion de la foto?', 2,'Sergio Ramos marcó este gol en la final de Lisboa en el minuto 93 provocando la prórroga, lo que finalizaría con la Décima Champion para el conjunto blanco','Lisboa',NULL,NULL,1,NULL,NULL)");
        //db.execSQL("INSERT INTO Preguntas VALUES (4, 'Multiple', '¿Cuáles de estos equipos han ganado alguna Liga?', 3,'El Real Sociedad ganó dos trofeos ligueros en 1981 y 1982, el Sevilla ganó este trofeo únicamente en 1946 y el Betis en 1935','Real Sociedad|Sevilla|Betis',NULL,NULL,NULL,NULL,NULL)");
        //db.execSQL("INSERT INTO Preguntas VALUES (5, 'Switch', '¿Lionel Messi es el futbolista que más veces ha ganado el Trofeo Pichichi de la Liga?', null,'Verdadero, Lionel Messi ha ganado este trofeo 7 veces, ademas tiene el record con mas goles en una temporada con 50 goles','true',NULL,NULL,NULL,NULL,NULL)");
        //db.execSQL("INSERT INTO Preguntas VALUES (6, 'ButtonImagen', '¿Cuál de todas estas imagenes corresponde con un penalti?', 4,'Un penalti consiste en lanzar un tiro desde el punto ubicado a 11 metros de la portería.','imagen_tiro_penalti',NULL,NULL,2,NULL,NULL)");
        //db.execSQL("INSERT INTO Preguntas VALUES (7, 'Button', '¿Cuál es el equipo español que ha conseguido mayor diferencia de goles en una eliminatoria de competición europea?', 4,'El Rayo Vallecanó ganó 10-0 en la ida y 0-6 en la vuelta contra el Constelació Esportiva de Andorra en la UEFA de la temporada 2000/2001','Rayo Vallecano',NULL,NULL,NULL,NULL,NULL)");
        db.execSQL("INSERT INTO Preguntas VALUES (8, 'Sonido', '¿A que competicion corresponde la siguiente canción?',  5,'','Champions League',NULL,NULL,NULL,'sound_champions',NULL)");
        db.execSQL("INSERT INTO Preguntas VALUES (9, 'Video', '¿Que trofeo gano el REal Madrid con este gol de Zidane?',  6,'','Champions League',NULL,NULL,NULL,NULL,'video_gol_zidane')");/*https://www.youtube.com/watch?v=YkACI8QHpe4*/
